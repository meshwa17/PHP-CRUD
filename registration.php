...
<form action="regprocess.php" style="border:1px solid #ccc" method="POST">
  <div class="container">
    <h1>Sign Up</h1>
    ...
    <input type="password" placeholder="Password Must be 8 character" name="password" minlength="8" required>
...
<!--     <label>
    ...
    <div class="clearfix">
      ...
      <button type="submit" class="signupbtn" name="btn_sb">Sign Up</button>
    </div>
