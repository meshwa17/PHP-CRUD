...
<!-- Mirrored from swlabs.co/edugate/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Jul 2020 18:47:28 GMT -->
<head><title>Department of Physics</title>
    <meta charset="utf-8">
    ...
    <script type="assets/js/jquerydata.js"></script>
 <!--  <script type="assets/js/dataTables.buttons.min.js"></script> -->

 <!--  <script type="assets/js/jquery.dataTables.min.js"></script> -->
  <script type="assets/js/buttons.html5.min.js"></script>
<!-- Popper JS -->
